...
namespace HDMapStandalone {
	...
	class LIBEXPORT MLocationTS
	{
	public:

		//@brief Constructor.
		//@param hdmap_ represents reference to class MHDMapTS object.
		MLocationTS(const MHDMapTS& hdmap_);
		...
		bool IsInsideLane(const SSD::SimPoint3D& inputPt, const SSD::SimString& laneName, MSideState& sideState) const;
		...
		//@return Returns true if input point is inside, else returns false.
		bool IsInsideRoad(const SSD::SimPoint3D& inputPt, const long& roadId) const;
		...
		bool GetNearMostLane(const SSD::SimPoint3D& inputPt, SSD::SimString& laneName, double& s, double& t,
			double& s_toCenterLine, double& t_toCenterLine) const;
		...
		//@return Returns true if the lane is found, else returns false.
		bool GetNearMostLane_V2(const SSD::SimPoint3D& inputPt, SSD::SimString& laneName, double& s, double& t,
			double& s_toCenterLine, double& t_toCenterLine) const;
		...
		//@return Returns true if the lane is found, else returns false.
		bool GetNearMostLaneWithHeight_V2(const SSD::SimPoint3D& inputPt, bool drivingOnly, SSD::SimString& laneName, double& s, double& t,
			double& s_toCenterLine, double& t_toCenterLine, bool& insideLane) const;
		...
		//insideLane is as an output parameter, which returns whether input point is inside the near most lane or not.
		//@return Returns true if the lane is found, else returns false.
		bool GetNearMostLaneWithHeight_V2(const SSD::SimPoint3D& inputPt, const SSD::SimVector<MLaneType>& laneTypeList, SSD::SimString& laneName, double& s, double& t,
			double& s_toCenterLine, double& t_toCenterLine, bool& insideLane) const;
		...
		//@return Returns true if the lane is found, else returns false.
		bool GetNearLanes(const SSD::SimPoint3D& inputPt, const double& distance, SSD::SimStringVector& laneList) const;
		...
		//laneList is as an output parameter, which returns the laneId list(with this format roadId_sectionIndex_laneId) of the found lanes.
		//@return Returns true if the lane is found, else returns false.
		bool GetNearLanes(const SSD::SimPoint3D& inputPt, const double& distance, const double& headingAngle, const double& angleShift, SSD::SimStringVector& laneList) const;
		...
		//@return Returns true if the lane is found, else returns false.
		bool GetNearLanes(const SSD::SimPoint3D& inputPt, const double& distance, SSD::SimStringVector& laneList,
			SSD::SimVector<double>& s_toCenterLineList, SSD::SimVector<double>& t_toCenterLineList) const;
		...
		//[s_toCenterLine, t_toCenterLine]'s values are fuzzy accurate, please use GetST or GetSTFast for highly accurate values.
		//@return Returns true if the lane is found, else returns false.
		bool GetNearLanes(const SSD::SimPoint3D& inputPt, const double& distance, const double& headingAngle, const double& angleShift,
			SSD::SimStringVector& laneList, SSD::SimVector<double>& s_toCenterLineList, SSD::SimVector<double>& t_toCenterLineList) const;
		...
		bool GetNearMostLaneMiddlePoint(const SSD::SimPoint2D& inputPt, SSD::SimPoint2D& targetPoint, SSD::SimPoint2D& dir) const;
		...
		//dir is an output parameter that returns the direction at the middle point.
		//@return Returns true if the lane and the middle point is found, else returns false.
		bool GetNearMostLaneMiddlePoint(const SSD::SimPoint3D& inputPt, SSD::SimPoint3D& targetPoint, SSD::SimPoint3D& dir) const;
		...
		bool GetNearMostLaneMiddlePoint(const SSD::SimPoint2D& inputPt, MLaneType laneType, SSD::SimPoint2D& targetPoint, SSD::SimPoint2D& dir) const;
		...
		//dir is an output parameter that returns the direction at the middle point.
		//@return Returns true if the lane satifies laneType and the middle point is found, else returns false.
		bool GetNearMostLaneMiddlePoint(const SSD::SimPoint3D& inputPt, MLaneType laneType, SSD::SimPoint3D& targetPoint, SSD::SimPoint3D& dir) const;
		...
		bool GetHeights(const SSD::SimPoint3D& inputPt, const double& radius, SSD::SimVector<double>& heights, SSD::SimVector<long>& roadIds, SSD::SimVector<bool>& insideRoadStates) const;
		...
		SSD::SimPoint3D GetNormal(const SSD::SimPoint2D& pt1, const SSD::SimPoint2D& pt2, const SSD::SimPoint2D& pt3, const SSD::SimString& laneName) const;
		...
		bool GetLaneMiddlePoint(const SSD::SimPoint2D& inputPt, const SSD::SimString& laneName, SSD::SimPoint2D& targetPoint, SSD::SimPoint2D& dir) const;
		...
		//dir is an output parameter that returns the direction at the middle point.
		//@return Returns true if the middle point is found, else returns false.
		bool GetLaneMiddlePoint(const SSD::SimPoint3D& inputPt, const SSD::SimString& laneName, SSD::SimPoint3D& targetPoint, SSD::SimPoint3D& dir) const;
		...
		bool DistanceToLaneBoundary(const SSD::SimPoint3D& inputPt, SSD::SimString& laneName, double& distToLeft, double& distToRight,
			double& distToLeftIn2D, double& distToRightIn2D) const;
		...
		//else returns false.
		bool DistanceToLaneBoundary(const SSD::SimString& laneName, const SSD::SimPoint3D& inputPt, double& distToLeft, double& distToRight,
			double& distToLeftIn2D, double& distToRightIn2D) const;
		...
		bool GetST(const SSD::SimString& laneName, const SSD::SimPoint3D& inputPt, double& s, double& t, double& z) const;
		...
		//z is the output value that represents the height value of inputPt in localENU.
		//@return Returns true if input laneName is a valid lane and is able to calculate [s, t], else returns false.
		bool GetSTFast(const SSD::SimString& laneName, const SSD::SimPoint3D& inputPt, double referenceS, double& s, double& t, double &z) const;
		...
		//@return Returns true if input laneName is a valid lane and is able to calculate [s, t], else returns false.
		bool GetLaneST(const SSD::SimString& laneName, const SSD::SimPoint3D& inputPt, double& s, double& t) const;
		...
		//@return Returns true if input laneName is a valid lane and is able to calculate [s, t], else returns false.
		bool GetInertialFromLaneST(const SSD::SimString& laneName, const double& s, const double& t, SSD::SimPoint3D& inertial, SSD::SimPoint3D& dir) const;
		...
		bool GetInertialFromRoadST(const long& roadId, const double& s, const double& t, SSD::SimPoint3D& inertial, SSD::SimPoint3D& dir) const;
		...
		bool IsOverlapLaneLine(const SSD::SimPoint3D& inputPt, const double& radius, SSD::SimString& laneId) const;
		...
		//@return Returns true if overlaps, else returns false.
		bool IsOverlapLaneLine(const SSD::SimString& laneId, const SSD::SimPoint3D& frontLeft, const SSD::SimPoint3D& frontRight,
			const SSD::SimPoint3D& rearLeft, const SSD::SimPoint3D& rearRight, bool& overlapLeft, bool& overlapRight) const;
		...
		bool GetRoadMark(const SSD::SimPoint3D& inputPt, const SSD::SimString& laneName, MRoadMark& left, MRoadMark& right) const;
		...
		bool IsInJunction(const SSD::SimPoint3D& inputPt, const SSD::SimVector<MLaneType>& laneTypeList, long& juncId) const;

		//@brief Check whether specified point belongs to a bridge in geometry.
		//@param inputPt is a 3d point.
		//laneName is current lane which inputPt belongs to. It can be got by API GetNearmostLaneWithHeight_v2. It is with this format roadId_sectionIndex_laneId.
		//@return Returns true if the speified point belongs to a bridge, else returns false.
		bool IsInBridge(const SSD::SimString& laneName, const SSD::SimPoint3D& inputPt);
	
		//@brief Check whether specified point belongs to a tunnel in geometry.
		//@param inputPt is a 3d point.
		//laneName is current lane which inputPt belongs to. It can be got by API GetNearmostLaneWithHeight_v2. It is with this format roadId_sectionIndex_laneId.
		//@return Returns true if the speified point belongs to a tunnel, else returns false.
		bool IsInTunnel(const SSD::SimString& laneName, const SSD::SimPoint3D& inputPt);

		//@brief Check whether specified point is inside any/multiple parkingSpace(s).
		//@param inputPt is a 3d point. Only (x,y) 2d values are used for searching.
		//radius is searching radius.
		//@return Returns true if the speified 2d point belongs to any parkingSpace, else returns false.
		bool InsideParkingSpace(const SSD::SimPoint3D& inputPt, const double& radius) const;

		//@brief Check whether specified point is inside any/multiple parkingSpace(s).
		//@param inputPt is a 3d point. Only (x,y) 2d values are used for searching.
		//radius is searching radius.
		//parkingSpaceList is as an output parameter, which returns valid parkingSpace list.
		//@return Returns true if the speified 2d point belongs to any parkingSpace, else returns false.
		bool InsideParkingSpace(const SSD::SimPoint3D& inputPt, const double& radius, SSD::SimVector<HDMapStandalone::MParkingSpace>& parkingSpaceList) const;
