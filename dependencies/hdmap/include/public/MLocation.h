...
public:
	...
	static bool IsInBridge(const SSD::SimString& laneName, const SSD::SimPoint3D& inputPt);
	...
	static bool IsInTunnel(const SSD::SimString& laneName, const SSD::SimPoint3D& inputPt);
	...
	static bool InsideParkingSpace(const SSD::SimPoint3D& inputPt, const double& radius);
	...
	//@return Returns true if the speified 2d point belongs to any parkingSpace, else returns false.
	static bool InsideParkingSpace(const SSD::SimPoint3D& inputPt, const double& radius, SSD::SimVector<HDMapStandalone::MParkingSpace>& parkingSpaceList);
};
}
